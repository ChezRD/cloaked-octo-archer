...
<div class="row top-margin-row" >
    <div class="row-fluid">
        <div class="col-md-6 col-md-offset-3 margin-bottom-form">
            <form id="<?php echo !isset($_FILES['file']['name']) == "" ? 'form-hide' : ''; ?>" class="bs-example form-horizontal" method="post" enctype='multipart/form-data' action="<?php echo "switcherBulk.php" ?>" >
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <div class="well">
                                    <fieldset>
                                        <legend class="text-center">Load a List of Lines</legend>
            ...
            <?php if ($_FILES): ?>
                        ...
                        <?php if($csv = processCsv($_FILES)): ?>
                            <?php foreach ($csv as $row): ?>
                                ...
                                <tr class="requestRowSwitcher">
                                    <td class="line"><?php echo "$row[0]"; ?></td>
                                    <td class="cluster"><?php echo "$row[1]"; ?></td>
                                    <td class="status"></td>
                                    <td class="message"></td>
                                    <td class="code"></td>
                                </tr>
                ...
                <?php else: ?>
                    ...
                    <a href="switcherBulk.php">Go Back</a>
                <?php endif ?>
            <?php endif ?>
        </div>
    </div>
