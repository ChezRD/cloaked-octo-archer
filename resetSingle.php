...
<div class="row top-margin-row" >
    <div class="row-fluid">
        <div class="col-md-6 col-md-offset-3 margin-bottom-form">
            <form id="<?php echo !isset($_REQUEST['deviceName']) == "" ? 'form-hide' : ''; ?>" class="bs-example form-horizontal" method="post" action="<?php echo "resetSingle.php" ?>" >
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <div class="well">
                                    <fieldset>
                                        <legend class="text-center">Reset single phone</legend>
